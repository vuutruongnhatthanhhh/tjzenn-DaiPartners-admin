...
interface PracticeUpdateProps {
  practice: Practice;
  onClose: () => void;
  onUpdate: (updated: Practice) => void;
}
...
export default function PracticeUpdate({
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        toast.error("Không tải được dữ liệu practice/nhân sự");
      } finally {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Cập nhật practice thành công", {
      ...
      console.error("Update practice error:", message);
    } finally {
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-[#1c1c1e] rounded-xl w-full max-w-7xl h-[90vh] relative flex flex-col">
        ...
        <div className="sticky top-0 z-10 bg-[#1c1c1e] p-6 border-b border-white/10">
          <h2 className="text-2xl font-bold text-white">Cập nhật practice</h2>
          <button
